    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (d[0].equals("SELECT SYMPTOM") && d[1].equals("SELECT SYMPTOM") && d[2].equals("SELECT SYMPTOM") && d[3].equals("SELECT SYMPTOM") && d[4].equals("SELECT SYMPTOM") && d[5].equals("SELECT SYMPTOM") && d[6].equals("SELECT SYMPTOM")) {

                    Toast.makeText(Symptoms.this, "Please Choose at least one Symptoms", Toast.LENGTH_SHORT).show();
                }
                ...
                Intent dis_page = new Intent(Symptoms.this, Disease.class);
